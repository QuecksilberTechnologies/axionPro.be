...
namespace axionpro.api.Controllers.Employee
{
    ...
    public partial class EmployeeController : ControllerBase
    {
        ...
        /// <para>Response DTO property analysis: ApiResponse: IsSucceeded (bool), Message (string), Data (T), Errors (List&lt;string&gt;), ErrorCode (string?), PageNumber (int?), PageSize (int?), TotalRecords (int?), TotalPages (int?), IsPrimaryMarked (bool?), HasAllDocUploaded (bool?), CompletionPercentage (double?); GetBaseEmployeeResponseDTO: Id (string?), EmployementCode (string?), LastName (string?), MiddleName (string?), FirstName (string?), GenderId (int), DesignationName (string?), DepartmentName (string?), EmergencyContactPerson (string?), EmergencyContactNumber (string?), BloodGroup (string?), MobileNumber (string?), Relation (int?), RelationType (string?), CountryId (int?), CountryCode (string?), Nationality (string?), RoleName (string?), RoleId (int?), RoleType (int?), Type (string?), DateOfBirth (DateTime?), DateOfOnBoarding (DateTime?), DateOfExit (DateTime?), DesignationId (int), GenderName (string?), EmployeeTypeId (int), DepartmentId (int), OfficialEmail (string?), HasPermanent (bool?), IsActive (bool), IsEditAllowed (bool?), IsMarried (bool?), IsInfoVerified (bool?), CompletionPercentage (double)</para>
        ...
        /// <para>Handler flow: GetAllEmployeeInfoQuery is processed by GetAllEmployeeInfoQueryHandler; operation(s): GetAllInfo, including a page-batched active Tenant role lookup.</para>
        /// <para>Response DTO property analysis: ApiResponse: IsSucceeded (bool), Message (string), Data (T), Errors (List&lt;string&gt;), ErrorCode (string?), PageNumber (int?), PageSize (int?), TotalRecords (int?), TotalPages (int?), IsPrimaryMarked (bool?), HasAllDocUploaded (bool?), CompletionPercentage (double?); GetAllEmployeeInfoResponseDTO: EmployeeId (string?), EmployementCode (string?), LastName (string?), MiddleName (string?), FirstName (string?), GenderId (int), GenderName (string?), CountryId (int), CountryCode (string?), MobileNumber (string?), Nationality (string), DateOfBirth (string?), DateOfOnBoarding (string?), DepartmentId (int), DepartmentName (string?), DesignationId (int), DesignationName (string?), EmployeeTypeId (int), EmployeeTypeName (string?), OfficialEmail (string?), EmergencyContactPerson (string?), IsActive (bool), EmployeeImagePath (string?), CompletionPercentage (double?), HasImagePicUploaded (bool?), MaxRoleAssigned (int), AssignedRoles (List&lt;AssignedEmployeeRoleDTO&gt;); AssignedEmployeeRoleDTO: Id (int), Code (string), Name (string), Type (string: SYSTEM/CUSTOM)</para>
