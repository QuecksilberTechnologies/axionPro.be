...
namespace axionpro.api.Controllers.Employee
{
    ...
    public class ExperienceController : ControllerBase
    {
        ...
        /// <para>Response DTO property analysis: ApiResponse: IsSucceeded (bool), Message (string), Data (T), Errors (List&lt;string&gt;), ErrorCode (string?), PageNumber (int?), PageSize (int?), TotalRecords (int?), TotalPages (int?), IsPrimaryMarked (bool?), HasAllDocUploaded (bool?), CompletionPercentage (double?); GetEmployeeExperienceResponseDTO: Id (long), EmployeeId (string?), Ctc (decimal?), CompanyName (string?), Designation (string?), EmployeeIdOfCompany (string?), StartDate (DateTime?), EndDate (DateTime?), Experience (int?), IsWFH (bool), WorkingCountryId (int?), WorkingStateId (int?), WorkingDistrictId (int?), IsForeignExperience (bool), ReasonForLeaving (string?), Remark (string?), ColleagueName (string?), ColleagueDesignation (string?), ColleagueContactNumber (string?), ReportingManagerName (string?), ReportingManagerNumber (string?), VerificationEmail (string?), CompletionPercentage (double), IsAnyGap (bool), ReasonOfGap (string?), GapYearFrom (DateTime?), GapYearTo (DateTime?), IsExperienceVerified (bool?), IsExperienceVerifiedByMail (bool?), IsExperienceVerifiedByCall (bool?), IsInfoVerified (bool?), IsEditAllowed (bool?), Documents (List&lt;GetEmployeeExperienceDocumentDTO&gt;?)</para>
