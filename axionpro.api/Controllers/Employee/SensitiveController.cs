...
namespace axionpro.api.Controllers.Employee
{
    ...
    public class SensitiveController : ControllerBase
    {
        ...
        /// <para>Response DTO property analysis: ApiResponse: IsSucceeded (bool), Message (string), Data (T), Errors (List&lt;string&gt;), ErrorCode (string?), PageNumber (int?), PageSize (int?), TotalRecords (int?), TotalPages (int?), IsPrimaryMarked (bool?), HasAllDocUploaded (bool?), CompletionPercentage (double?); GetEmployeeIdentityResponseDTO: Id (long?), EmployeeId (string?), CountryCode (string), CountryName (string), IdentityCategoryName (string), IdentityCategoryDocumentId (int), DocumentCode (string), DocumentName (string), Description (string?), IsMandatory (bool), EmployeeIdentityId (long?), IdentityValue (string?), IsVerified (bool?), IsEditAllowed (bool?), HasIdentityUploaded (bool?), EffectiveFrom (DateTime?), EffectiveTo (DateTime?), IsActive (bool?)</para>
