...
public sealed class TenantParentModuleController : ControllerBase
{
    ...
    #region Tenant Parent Module Queries
        ...
        /// <para>Response DTO property analysis: ApiResponse: IsSucceeded (bool), Message (string), Data (T), Errors (List&lt;string&gt;), ErrorCode (string?), PageNumber (int?), PageSize (int?), TotalRecords (int?), TotalPages (int?), IsPrimaryMarked (bool?), HasAllDocUploaded (bool?), CompletionPercentage (double?); TenantParentModuleResponseDTO: TenantId (string), Id (int), ModuleCode (string?), ModuleName (string?), DisplayName (string?), UrlPath (string?), ImageIconWeb (string?), ImageIconMobile (string?), ItemPriority (int?), ParentModuleId (int?), IsLeafNode (bool?), IsEnabled (bool), ModuleScope (short), Children (List&lt;TenantParentModuleResponseDTO&gt;)</para>
