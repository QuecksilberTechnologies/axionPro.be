...
{
    public static class EmployeeExperienceInfoMapperHelper
    {
        public static GetExperienceAccessResponseDTO ConvertToAccessResponseDTO<T>(T source)
        {
            var result = new GetExperienceAccessResponseDTO();

            var sourceProps = typeof(T).GetProperties();
            var targetProps = typeof(GetExperienceAccessResponseDTO).GetProperties();
