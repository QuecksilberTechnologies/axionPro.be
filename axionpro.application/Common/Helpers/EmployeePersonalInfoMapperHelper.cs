...
{
    public static class EmployeePersonalInfoMapperHelper
    {
        public static GetPersonalAccessResponseDTO ConvertToAccessResponseDTO<T>(T source)
        {
            var result = new GetPersonalAccessResponseDTO();

            var sourceProps = typeof(T).GetProperties();
            var targetProps = typeof(GetPersonalAccessResponseDTO).GetProperties();
