...
{
    /// <summary>
    /// Represents the UpdateEducationRequestDTO data transfer model.
    /// </summary>
    public class UpdateEducationRequestDTO : axionpro.application.DTOs.BaseDTO.PermissionRequestDTO
    {
