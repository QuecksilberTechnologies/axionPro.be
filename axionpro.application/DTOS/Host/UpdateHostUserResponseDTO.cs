...
// Role    : CEO
// Purpose : Represents host-user details returned after an update.
// ================================================================

namespace axionpro.application.DTOS.Host
{
    /// <summary>
    /// Represents the host-user details returned after an update operation.
    /// </summary>
    public class UpdateHostUserResponseDTO
    {
        #region Properties
        ...
        /// <summary>
        /// Gets or sets the date and time at which the host user was updated.
        /// </summary>
