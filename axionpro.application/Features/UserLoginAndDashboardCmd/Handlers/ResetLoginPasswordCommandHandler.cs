...
{
    //public class ResetLoginPasswordCommandHandler : IRequestHandler<ForgotPasswordCommand, ApiResponse<UpdatePasswordResponseDTO>>
    //{
    //    private readonly IMapper _mapper;
    //    private readonly IUnitOfWork _unitOfWork;
    //    private readonly IEmailService _emailService;
    //    private readonly ILogger<ResetLoginPasswordCommandHandler> _logger;

    //    public ResetLoginPasswordCommandHandler(
    //        IMapper mapper,
    //        IUnitOfWork unitOfWork,
             
    //        ILogger<ResetLoginPasswordCommandHandler> logger,  IEmailService emailService)
    //    {
    //        _logger = logger;
    //        _mapper = mapper;
