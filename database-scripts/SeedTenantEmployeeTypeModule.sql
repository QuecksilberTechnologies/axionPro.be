...
-- A prior entitlement sync could copy unrelated global operations into this tenant module.
...
-- ModuleOperationMapping is the master operation catalogue: CRUD plus bulk Import/Export.
