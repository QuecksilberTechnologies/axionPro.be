...
| Location / City-to-Locality refactor | [2026-09-16](location/locality-refactor/2026-09-16.md) | Target migration reconciled 8,333 rows; 7/7 focused and 167/170 combined regression tests passed (3 prerequisite skips); local DB-backed endpoint smoke passed; deployment acceptance pending. |
