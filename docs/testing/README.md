...
| Policy / durable bulk import | [2026-09-16](policy/bulk-import/2026-09-16.md) | Local build and focused contracts pass; PostgreSQL lifecycle and deployed acceptance remain blocked/pending. |
